...
//               className="space-y-2"
//             >
//               {['Home', 'About', 'Projects', 'Skills', 'Achievements', 'Contact'].map((item, index) => (
//                 <motion.button
//                   key={item}
//                   whileHover={{ x: 5 }}
...
Passionate about crafting seamless digital experiences that inspire and empower.
          ...
          <div>
            ...
            <motion.div
              ...
              className="space-y-2"
            >
              {['Home', 'About', 'Projects', 'Skills', 'Experience', 'Achievements', 'Certifications', 'Contact'].map((item, index) => (
                <motion.button
                  key={item}
                  whileHover={{ x: 5 }}
                  onClick={() => document.querySelector(`#${item.toLowerCase()}`)?.scrollIntoView({ behavior: 'smooth' })}
